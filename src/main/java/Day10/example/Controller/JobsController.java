...
import Day10.example.DTO.JobFilterDto;
import Day10.example.DAO.JobsDAO;
import jakarta.ws.rs.*;

import Day10.example.DTO.JobsDTO;
import Day10.example.Mappers.JobsMapper;
import Day10.example.Models.Jobs;

import java.net.URI;
import java.sql.SQLException;
import java.util.ArrayList;
import Day10.example.exceptions.DataNotFoundException;
